  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        ...
        >
          <GitHubIcon />
          <span className="font-medium text-gray-900">Continue with GitHub</span>
        </button>
      </div>
      ...
      <form onSubmit={handleSignup} className="space-y-4">
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full font-inter font-semibold text-[14px] text-white px-5 py-3 rounded-xl transition-colors hover:opacity-90 disabled:opacity-50"

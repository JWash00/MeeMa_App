...
import type { CreateResponse, QAStatus, CreateRequest, Audience, Tone, TikTokLength } from '@/src/contracts/create'
...
export default function YouTubeShortsPage() {
  ...
  async function onGenerate() {
    ...
    try {
      ...
      const response = await fetch('/api/youtube-shorts/generate', {
        method: 'POST',
    ...
    <div className="min-h-screen bg-gray-50">
      <header className="bg-white border-b border-gray-100 px-6 py-4">
        <div className="max-w-4xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="/prompts/tiktok" className="text-sm text-gray-600 hover:text-gray-900">
              TikTok
            </Link>
      ...
      <main className="max-w-4xl mx-auto px-6 py-8">
        <div className="mb-6">
          ...
          <p className="text-gray-600 mt-1">Generate a YouTube Shorts script with hook, shotlist, and on-screen text.</p>
        </div>

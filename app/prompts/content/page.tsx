...
import type { CreateResponse, QAStatus, CreateRequest, Audience, Length, Tone } from '@/src/contracts/create'
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-4xl mx-auto px-6 py-8">
        <div className="mb-6">
          ...
          <p className="text-gray-600 mt-1">Generate educational articles and explanations.</p>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-4 space-y-4">
          <textarea
            ...
            placeholder='e.g. "Explain how machine learning works" or "Write a tutorial on React hooks"'
